...
const newsItems = [
  {
    id: 10,
    title: 'رفع قطعی باگ‌های شمارنده کارکرد روزانه! (مهم) 🚀',
    category: 'به‌روزرسانی مهم',
    date: 'همین الان',
    description: 'کارشناسان عزیز؛ خبر خوب! سیستم شمارش کارکردهای روزانه شما از پایه بازنویسی و متحول شد. در گذشته به دلیل ذخیره موقت اطلاعات روی مرورگر شما (حافظه گوشی یا سیستم)، گاهی با پاک کردن کش یا تغییر دستگاه، آمار روزانه‌تان صفر می‌شد یا عدد اشتباهی نشان می‌داد. اما از این لحظه به بعد، شمارنده بالای پنل شما مستقیماً به هسته مرکزی سرور متصل شده است! این یعنی عدد کارکرد شما به صورت کاملاً زنده، دقیق و بدون خطا محاسبه می‌شود و دیگر محال است عددی که در پنل خود می‌بینید با گزارش نهایی مدیریت تفاوتی داشته باشد. هیچ‌کدام از تماس‌ها و زحمات روزانه شما دیگر از بین نخواهد رفت؛ با خیالِ راحتِ ۱۰۰ درصدی به کار خود ادامه دهید.',
