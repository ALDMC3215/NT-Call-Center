...
const techniques = [
  ...
  },
  {
    ...
    content: 'فروشنده‌ها به جای توضیح دادن، با سؤال‌های هدفمند، مشتری را درگیر مکالمه می‌کنند و کنترل گفتگو همیشه در دست آنهاست. نمونه سؤال‌ها: الان روی چه سهم‌هایی سرمایه‌گذاری کرده‌اید؟ چند سال است در این بازار فعال هستید؟ هدفتان از سرمایه‌گذاری چیست؟ به دنبال رشد کوتاه‌مدت هستید یا بلندمدت؟',
  ...
  },
  {
    ...
    content: 'فروشندگان به جای توضیح ویژگی‌های سهم، روی آینده و سود بالقوه آن تمرکز می‌کنند. آنها نتیجه را می‌فروشند، نه ویژگی را. فروش ویژگی یعنی «این سهم پتانسیل رشد بالایی دارد و از نظر بنیادی قوی است.» اما فروش نتیجه یعنی «این سهم می‌تواند سرمایه شما را در ماه‌های آینده چند برابر کند.»',
    lesson: 'به جای توضیح ویژگی‌ها، به مشتری کمک کنید تصویر آینده از خرید را ببیند. مشتری با آینده بهتر تصمیم می‌گیرد، نه با اطلاعات بیشتر.',
